...
import Calendar from "../Calendar/Calendar"; // Calendar komponent yolunu özünüzə görə tənzimləyin
...
function Dashboard() {
  ...
  const [showCalendar, setShowCalendar] = useState(false); // modal görünüş vəziyyəti
    ...
    <>
      <nav id="dashboard">
        ...
        <ul className="nav-menu">
          ...
          {/* Yeni Calendar açmaq üçün düymə */}
          <li style={{ marginTop: "1rem" }}>
            <button
              className="nav-link calendar-button"
