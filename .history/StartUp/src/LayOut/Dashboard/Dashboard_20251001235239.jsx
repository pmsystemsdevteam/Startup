  ...
  return (
    <nav id="dashboard">
      ...
      <ul className="nav-menu">
        ...
        {/* Lead müraciət səhifəsi - staff xaric hamı görür */}
        {user.jobtype !== "staff" && (
          <li>
            <NavLink
        ...
        {/* Lead müraciət tarixçəsi - staff xaric hamı görür */}
        {user.jobtype !== "staff" && (
          <li>
            <NavLink
              ...
              className={({ isActive }) => (isActive ? "nav-link active" : "nav-link")}
            >
              Rəhbər müraciət tarixçəsi
            </NavLink>
          </li>
        )}

        {/* Rəhbər icazə keçmişi - staff xaric hamı görür */}
        {user.jobtype !== "staff" && (
          <li>
            <NavLink
              to={`/${
